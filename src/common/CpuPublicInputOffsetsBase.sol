...
contract CpuPublicInputOffsetsBase is PageInfo {
    ...
    // NOTE: Index 0 is reserved for n_verifier_friendly_commitment_layers (Stone prover format)
    uint256 internal constant OFFSET_N_VERIFIER_FRIENDLY_COMMITMENT_LAYERS = 0;
